...
var Collapsible = function (_a) {
    ...
    return (React.createElement(CollapsibleProvider, null,
        React.createElement(Container$3, null, children)));
};
...
var ToggleSwitch = function (_a) {
    ...
    React.createElement(Container$2, null,
...
var Close = styled.button(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background: none;\n  border: none;\n  font-size: 30px;\n  line-height: 0;\n  padding: 0;\n  position: absolute;\n  top: 10px;\n  right: 10px;\n"], ["\n  background: none;\n  border: none;\n  font-size: 30px;\n  line-height: 0;\n  padding: 0;\n  position: absolute;\n  top: 10px;\n  right: 10px;\n"])));
var templateObject_1, templateObject_2;

var setAppElement = function (appEl) { return ReactModal.setAppElement(appEl); };
var Modal = function (_a) {
    var children = _a.children, isOpen = _a.isOpen, onRequestClose = _a.onRequestClose, onAfterClose = _a.onAfterClose, onAfterOpen = _a.onAfterOpen, elementToFocusOnOpen = _a.elementToFocusOnOpen, _b = _a.hideCloseButton, hideCloseButton = _b === void 0 ? false : _b;
    var overlayWindowElement;
    var handleCloseModal = function () {
        onRequestClose && onRequestClose();
    };
    var handleAfterClose = function () {
    ...
    return (React.createElement(Container, null,
        React.createElement(ReactModal, { isOpen: isOpen, onAfterOpen: handleAfterOpen, onAfterClose: handleAfterClose, style: customStyles, contentRef: function (element) { return (overlayWindowElement = element); } },
            !hideCloseButton && (React.createElement(Close, { onClick: handleCloseModal },
                React.createElement(FaTimesCircle, null))),
            children)));
};

export { CodeBlock, Collapsible, CollapsibleBody, CollapsibleHead, Example, Modal, ToggleSwitch, setAppElement };
